  ...
  render: ->
    `<div className='form-group'>
      <div className='input-group strech-horizontal'>
        ...
        <input id={ this.field_id() } className='form-control' type={ this.props.type } defaultValue={ this.props.value } onChange={ this.props.on_change } placeholder={ this.hint() } data-error={ this.error_message() } required={ this.props.is_required } readOnly={ this.is_readonly() } />
      </div>
